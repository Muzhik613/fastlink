// node --test — an EXACT text match on a control the user can see wins over the same text
// buried in longer text, and a control the click relabelled says so in `changed`.
