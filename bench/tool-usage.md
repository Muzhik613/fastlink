...
79 cell(s), ALL passes, one table per toolset × model, from `bench/tool-usage.jsonl`. Regenerate: `node bench/drive-runner.js usage`.
...
## toolset `phase2 / grok-4.3` — 37 cell(s): multipage×6, staticform×6, overlay×6, flightsearch×6, mapsdir×7, extract×6

| tool | calls | errors | avg ms | retry | switch | fumble % | tests used in |
|---|---:|---:|---:|---:|---:|---:|---|
| fast_snapshot | 61 | 0 | 79 | 0 | 0 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_click | 53 | 19 | 510 | 9 | 0 | 17 | multipage, staticform, overlay, mapsdir |
| fast_tab | 37 | 0 | 326 | 0 | 0 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_fill | 27 | 4 | 326 | 1 | 0 | 4 | staticform, overlay, flightsearch, mapsdir |
| fast_text | 24 | 1 | 24 | 1 | 0 | 4 | staticform, overlay, flightsearch, mapsdir, extract |
| fast_key_press | 13 | 0 | 34 | 0 | 0 | 0 | overlay, mapsdir |
| fast_select_option | 10 | 1 | 739 | 0 | 0 | 0 | staticform, overlay, flightsearch, mapsdir |
| fast_wait | 10 | 8 | 11177 | 0 | 0 | 0 | mapsdir |
| fast_batch | 9 | 0 | 2490 | 0 | 0 | 0 | staticform, flightsearch |
| fast_click_xy | 2 | 0 | 67 | 0 | 0 | 0 | overlay |

Total: 246 calls across 10 distinct tools; 11 fumbles (4%).
