...
122 cell(s), ALL passes, one table per toolset × model, from `bench/tool-usage.jsonl`. Regenerate: `node bench/drive-runner.js usage`.
...
## toolset `phase2 / grok-4.3` — 80 cell(s): multipage×13, staticform×13, overlay×13, flightsearch×13, mapsdir×15, extract×13

| tool | calls | errors | avg ms | retry | switch | fumble % | tests used in |
|---|---:|---:|---:|---:|---:|---:|---|
| fast_snapshot | 137 | 0 | 74 | 0 | 0 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_tab | 80 | 0 | 347 | 0 | 0 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_click | 79 | 22 | 445 | 10 | 2 | 15 | multipage, staticform, overlay, mapsdir |
| fast_text | 43 | 2 | 24 | 2 | 0 | 5 | staticform, overlay, flightsearch, mapsdir, extract |
| fast_fill | 37 | 4 | 305 | 1 | 0 | 3 | staticform, overlay, flightsearch, mapsdir |
| fast_batch | 21 | 0 | 2530 | 0 | 0 | 0 | staticform, flightsearch |
| fast_wait | 21 | 16 | 9431 | 0 | 0 | 0 | multipage, mapsdir |
| fast_key_press | 19 | 0 | 73 | 0 | 0 | 0 | overlay, mapsdir |
| fast_select_option | 18 | 1 | 779 | 0 | 0 | 0 | staticform, overlay, flightsearch, mapsdir |
| fast_click_xy | 2 | 0 | 67 | 0 | 0 | 0 | overlay |

Total: 457 calls across 10 distinct tools; 15 fumbles (3%).
