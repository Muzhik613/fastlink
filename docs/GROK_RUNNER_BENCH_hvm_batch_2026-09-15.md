...
Client `grok_runner`, 4 pass(es) over 6 tests, driven by `bench/hvm-run.sh` on the hvm rig (Xvfb + Chrome for Testing + unpacked fast-ext + local broker; grokcode proxy :8791). Rows since 2026-09-15T18:16:53.000Z.
...
Runtime per pass: pass 1 on 3b2c772 (grok-4.3, phase2): batch build; pass 2 on 7d43d8a: select hints skip autocompletes, ARIA aria-controls wall clock, runBridge deadline; pass 3 on bf55fda: suggestions signal on key_press+fill, trail poll 0.5s; pass 4 on fdd9caf: fast_click commits suggestion entries; pass 4 on fdd9caf (grok-4.3, toolset phase2);

Run store per pass (model/toolset): pass 1 = grok-4.3/phase2; pass 2 = grok-4.3/phase2; pass 3 = grok-4.3/phase2; pass 4 = grok-4.3/phase2.
...
| mapsdir | 4/6 25.7s 9c m=11.7s ~ | 5/6 9.6s 7c m=13.4s ! | 4/6 36.8s 15c m=19.4s ~ | 5/6 93.8s 19c m=31.4s ! | 9.6s | 31.3s | 12 | 4–5/6 | 41.9s | −32.3s (-77%) |
...
Totals over valid cells: 24 cells, 227/236 checkpoints, 136 tool calls, 298.7s wall.
...
|---|---:|---:|---:|---:|---|
| fast_snapshot | 39 | 0 | 57 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_click | 24 | 8 | 575 | 7 | multipage, overlay, mapsdir |
| fast_tab | 24 | 0 | 373 | 0 | multipage, staticform, overlay, flightsearch, mapsdir, extract |
| fast_text | 19 | 1 | 24 | 2 | staticform, overlay, flightsearch, mapsdir, extract |
| fast_batch | 8 | 0 | 2413 | 0 | staticform, flightsearch |
| fast_key_press | 6 | 0 | 30 | 0 | mapsdir |
| fast_wait | 6 | 6 | 14244 | 6 | mapsdir |
| fast_fill | 5 | 0 | 145 | 0 | mapsdir |
| fast_select_option | 5 | 1 | 1414 | 0 | overlay, mapsdir |

Total: 136 calls across 9 distinct tools, 15 fumbles.
